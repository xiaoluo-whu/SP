package com.bnq.supplier.sp.common.util;
...
public class SPUtil {
    ...
    private static final MyLog _log = MyLog.getLog(SPUtil.class);
    ...
    public static Map<String, Object> makeRetMap(String retCode, String retMsg, String resCode, String errCode, String errCodeDesc) {
        ...
        if(retCode != null) retMap.put(Constant.RETURN_PARAM_RETCODE, retCode);
        if(retMsg != null) retMap.put(Constant.RETURN_PARAM_RETMSG, retMsg);
        if(resCode != null) retMap.put(Constant.RESULT_PARAM_RESCODE, resCode);
        if(errCode != null) retMap.put(Constant.RESULT_PARAM_ERRCODE, errCode);
        if(errCodeDesc != null) retMap.put(Constant.RESULT_PARAM_ERRCODEDES, errCodeDesc);
        return retMap;
    }
...
//        if(resCode != null) retMap.put(Constant.RESULT_PARAM_RESCODE, resCode);
//        if(payEnum != null) {
//            retMap.put(Constant.RESULT_PARAM_ERRCODE, payEnum.getCode());
//            retMap.put(Constant.RESULT_PARAM_ERRCODEDES, payEnum.getMessage());
//        }
//        return retMap;
//    }

//    public static String makeRetData(Map retMap, String resKey) {
//        if(retMap.get(Constant.RETURN_PARAM_RETCODE).equals(Constant.RETURN_VALUE_SUCCESS)) {
...
//    }
    ...
    public static String makeRetSuccess(Map retMap) {
        _log.info("生成响应数据:{}", retMap);
        return JSON.toJSONString(retMap);
    }
