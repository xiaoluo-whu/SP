package com.bnq.supplier.sp.common.constant;

public class Constant {
    public static final String RETURN_PARAM_RETCODE = "ret_code";
    public static final String RETURN_PARAM_RETMSG = "ret_msg";
    public static final String RESULT_PARAM_RESCODE = "res_code";
    public static final String RESULT_PARAM_ERRCODE = "err_code";
